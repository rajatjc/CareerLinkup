...
from CareerLinkup.models import Job, jobs_applied, Employer
from flask import render_template, Blueprint, request, abort
from CareerLinkup.forms import Job_Search
...
def job_list():
    ...
    return render_template("jobs/list.html", title="CareerLinkup | Jobs List", jobs=jobs, filtered=filtered, form1=form1, categories=categories)
...
def profile(job_id):
    ...
    return render_template("jobs/profile.html", title="CareerLinkup | Job Details", job=job, query=query)
...
def categories():
    ...
    return render_template("jobs/categories.html", title="CareerLinkup | Jobs Categories", jobs=jobs, form1=form1, categories=categories,pages=query)
...
def filtered(category):
    ...
    return render_template("jobs/filtered.html", title="CareerLinkup | Jobs List", jobs=jobs, form1=form1, head=head)
...
def job_search():
    ...
    return render_template("jobs/filtered.html", title="CareerLinkup | Job Search", jobs=jobs, head=head, form1=form1)
